    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Tambah Menu Minuman</li>
        </ol>
        ...
        <div class="alert alert-success" role="alert">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <a href="<?php echo site_url('kasir/menu_minuman') ?>"><i class="fas fa-arrow-left"></i>Back</a>
            </div>
          <div class="card-body">
            <form action="<?php base_url('kasir/menu_minuman/add') ?>" method="post" enctype="multipart/formdata" >
            ...
            <div class="formgroup">
              ...
              <input class="form-control <?php echo form_error('harga_minuman') ? 'is-invalid':'' ?>" type="number" name="harga_minuman" min="0" placeholder="Harga" />
              <div class="invalid-feedback">
