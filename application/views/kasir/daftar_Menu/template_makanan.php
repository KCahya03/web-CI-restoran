...
<body id="page-top">
  ...
  <?php $this->load->view("kasir/_partial/sidebar.php") ?>
    ...
    <div class="card mb-3">
          ...
          <a href="<?php echo site_url('kasir/menu_makanan/add') ?>"><i class="fas fa-plus"></i> Tambah Data Menu Makanan</a>
          </div>
          <div class="card-body">
                ...
                <tbody>
                  <?php foreach ($list_makanan as $list_makanan): ?>
                    <tr>
                      ...
                      <td width="250">
                        <a href="<?php echo site_url('kasir/menu_makanan/edit/'.$list_makanan->kode_makanan) ?>" class="btn btn-small"><i class="fas fa-edit"></i>
                          Edit</a>
                          <a onclick="deleteConfirm('<?php echo site_url('kasir/menu_makanan/delete/'.$list_makanan->kode_makanan) ?>')" href="#!" class="btn btn-small text-danger"><i class="fasfa-trash"></i> Hapus</a>
                        </td>
                      </tr>
                      <?php endforeach; ?>
                </tbody>
